        ...
        <div className={styles.order}>
          ...
          <div className={styles.globalContainer}>
            ...
            <div className={styles.shipping}>
              ...
              <form className={styles.flatRate}>
                <div>
                  <input
                    type="checkbox"
                    {...register("flatRate")}
            ...
            <div className={styles.bankTransfer}>
              <form className={styles.bankTransfertForm}>
                <input
                  type="checkbox"
                  {...register("bankTransfert")}
                  id="bankTransfert"
                  className={styles.orderCheckout}
                />
                <label htmlFor="bankTransfert">Direct bank transfer</label>
              </form>
              <p>
                Direct bank transfer, also known as a wire transfer, is a secure
                electronic method for moving funds between bank accounts.
              </p>
            </div>
            <form>
              <input
